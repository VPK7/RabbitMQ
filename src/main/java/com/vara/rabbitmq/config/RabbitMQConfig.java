package com.vara.rabbitmq.config;

import com.vara.rabbitmq.listener.RabbitMQMessageListener;
...
/*
1. Define the Queue listen to
2. Provide the connection to the queue
3. Bind the Queue, connection and the listener
 */
@Configuration
